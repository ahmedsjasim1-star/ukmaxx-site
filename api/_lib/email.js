...
<tr><td style="background-color:#F0F4F5;padding:20px 0">
  ...
  <tr><td align="center">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;background-color:#ffffff;border-radius:12px;overflow:hidden">
      ...
      <!-- Trust -->
      <tr><td style="padding:0 28px 28px"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse"><tr><td width="33%" style="text-align:center;padding:0 4px"><p style="font-family:'IBM Plex Mono',Menlo,Consolas,monospace;font-size:10px;font-weight:500;letter-spacing:0.08em;text-transform:uppercase;color:#0A7E8C;margin:0 0 4px;line-height:1">✓ Batch COA</p><p style="font-size:11px;color:#5B7B82;margin:0;line-height:1.4;font-family:Inter,Arial,sans-serif">Where available</p></td><td width="33%" style="text-align:center;padding:0 4px;border-left:1px solid #E6F0F2;border-right:1px solid #E6F0F2"><p style="font-family:'IBM Plex Mono',Menlo,Consolas,monospace;font-size:10px;font-weight:500;letter-spacing:0.08em;text-transform:uppercase;color:#0A7E8C;margin:0 0 4px;line-height:1">✓ UK Stock</p><p style="font-size:11px;color:#5B7B82;margin:0;line-height:1.4;font-family:Inter,Arial,sans-serif">Ready to dispatch</p></td><td width="33%" style="text-align:center;padding:0 4px"><p style="font-family:'IBM Plex Mono',Menlo,Consolas,monospace;font-size:10px;font-weight:500;letter-spacing:0.08em;text-transform:uppercase;color:#0A7E8C;margin:0 0 4px;line-height:1">✓ Secure</p><p style="font-size:11px;color:#5B7B82;margin:0;line-height:1.4;font-family:Inter,Arial,sans-serif">Stripe checkout</p></td></tr></table></td></tr>
      <!-- Footer -->
