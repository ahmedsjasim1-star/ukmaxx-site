export const PRODUCTS = {
  ...
  GHKCU:{id:'GHKCU',slug:'ghk-cu-50mg',name:'GHK-Cu 50MG',shortName:'GHK-Cu',description:'GHK-Cu 50mg lyophilised copper peptide, UK stocked with published Janoshik COA.',seoTitle:'GHK-Cu 50mg UK Research Peptide | COA Verified | UKMAXX',seoDescription:'GHK-Cu 50mg UK research peptide from UKMAXX. UK stocked, Janoshik HPLC COA verified, batch-traceable and dispatched with Royal Mail Tracked 24. Research use only.',aliases:['GHK-Cu 50mg','GHKCu 50mg','GHK copper peptide UK','GHK-Cu UK','GHKCU','research peptides UK','UK peptides'],purity:'99.799%',batch:'GHK-2026-05-A',price:29.99,reviewCount:0,image:'./images/ukmaxx-ghk-cu.png',category:'peptides',featured:false,stock:'in_stock',stockCount:19,sortOrder:30,coa:{lab:'Janoshik Analytical',method:'HPLC',status:'VERIFIED'},coaImage:'./images/ghkcu-coa-2026-07.png',coaSampleImage:'./images/ghkcu-coa-vial-2026-07.jpg',coaUrl:'https://verify.janoshik.com/tests/208700-GHKCu_50mg_ENTH4P5LPBYX'}
};
...
export const RESEARCH_FOCUS = {
  ...
  GHKCU: 'GHK-Cu is a copper-binding tripeptide studied in laboratory models involving copper-peptide complexes, extracellular matrix signalling and cellular-response pathways. This UKMAXX batch is third-party verified by Janoshik Analytical and supplied strictly for laboratory and in-vitro research use only.',
