export const PRODUCTS = {
  RT10:{id:'RT10',slug:'reta-10mg',name:'RETA 10MG',shortName:'RETA',description:'Retatrutide 10mg lyophilised research peptide, UK stocked with published third-party COA.',seoTitle:'Retatrutide 10mg UK Research Peptide | COA Verified | UKMAXX',seoDescription:'Buy Retatrutide 10mg research peptide from UKMAXX. UK stocked, Janoshik third-party COA verified, batch-traceable and dispatched with Royal Mail Tracked 24. Research use only.',purity:'99%+',batch:'RT10-2026-06-A',price:54.99,reviewCount:0,image:'./images/ukmaxx-reta.png',category:'peptides',featured:true,stock:'in_stock',stockCount:29,sortOrder:10,coa:{lab:'Janoshik Analytical',method:'UPLC/MS',status:'VERIFIED'},coaImage:'./images/reta-coa-2026-06.png',coaUrl:'https://verify.janoshik.com/tests/193587-RT10_I8UPPV43CJ42'},
  RT10X3:{id:'RT10X3',slug:'reta-3-pack',name:'RETA 3-PACK',shortName:'RETA KIT',description:'Three Retatrutide 10mg research vials from the same verified batch plus one BAC Water vial.',seoTitle:'Retatrutide 3 Pack UK Research Bundle | UKMAXX',seoDescription:'Retatrutide 3-pack research bundle with 3x 10mg RETA vials plus 1x BAC Water. UK stocked, batch-traceable and third-party COA verified by Janoshik. Research use only.',purity:'99%+',batch:'RT10-2026-06-A',price:149.99,originalPrice:173.96,reviewCount:0,image:'./images/ukmaxx-reta-bundle.png',category:'bundles',featured:true,stock:'in_stock',stockCount:9,sortOrder:10,coa:{lab:'Janoshik Analytical',method:'UPLC/MS',status:'VERIFIED'},coaImage:'./images/reta-coa-2026-06.png',coaUrl:'https://verify.janoshik.com/tests/193587-RT10_I8UPPV43CJ42'},
  BC5:{id:'BC5',slug:'bpc-157',name:'BPC 157',shortName:'BPC',description:'BPC-157 5mg lyophilised research peptide, UK stocked with published Janoshik COA.',seoTitle:'BPC-157 5mg UK Research Peptide | COA Verified | UKMAXX',seoDescription:'BPC-157 5mg research peptide from UKMAXX. UK stocked, Janoshik HPLC COA verified, batch-traceable and dispatched with Royal Mail Tracked 24. Research use only.',purity:'99.746%',batch:'BPC-2026-05-A',price:29.99,reviewCount:0,image:'./images/ukmaxx-bpc-157.png',category:'peptides',featured:false,stock:'in_stock',stockCount:19,sortOrder:20,coa:{lab:'Janoshik Analytical',method:'HPLC',status:'VERIFIED'},coaImage:'./images/bpc-coa-2026-07.png',coaSampleImage:'./images/bpc-coa-vial-2026-07.jpg',coaUrl:'https://verify.janoshik.com/tests/208699-BPC157_5mg_AK9GVE8V85T7'},
  IP5:{id:'IP5',slug:'ipam-5mg',name:'IPAM 5MG',shortName:'IPAM',description:'Ipamorelin 5mg research peptide listing with a published QC rejected batch record.',seoTitle:'Ipamorelin 5mg UK Research Peptide | Batch Transparency | UKMAXX',seoDescription:'Ipamorelin 5mg research peptide listing from UKMAXX. Current batch was QC rejected and is published for transparency. Next batch pending. Research use only.',purity:'99.429%',batch:'IPA-2026-05-A',price:24.99,reviewCount:0,image:'./images/ukmaxx-ipamorelin.png',category:'peptides',featured:false,stock:'coming_soon',stockCount:0,sortOrder:80,releaseLabel:'Next batch pending',coaLabel:'QC rejected batch published',coa:{lab:'Janoshik Analytical',method:'Ipamorelin analysis',status:'REJECTED'},coaUrl:'https://verify.janoshik.com/tests/208701-Ipamorelin_5mg_BHYXQQELT4GZ'},
  NJ500:{id:'NJ500',slug:'nad-500mg',name:'NAD+ 500MG',shortName:'NAD+',description:'NAD+ 500mg research coenzyme, UK stocked with published Janoshik assay result.',seoTitle:'NAD+ 500mg UK Research Coenzyme | COA Verified | UKMAXX',seoDescription:'NAD+ 500mg research coenzyme from UKMAXX. UK stocked, Janoshik assay verified, batch-traceable and dispatched with Royal Mail Tracked 24. Research use only.',purity:'568.26mg',qualityLabel:'568.26mg assay',batch:'NAD-2026-05-A',price:44.99,reviewCount:0,image:'./images/ukmaxx-nad-500.png',category:'coenzymes',featured:false,stock:'in_stock',stockCount:19,sortOrder:40,coa:{lab:'Janoshik Analytical',method:'NAD+ analysis',status:'VERIFIED'},coaImage:'./images/nad-coa-2026-07.png',coaSampleImage:'./images/nad-coa-vial-2026-07.jpg',coaUrl:'https://verify.janoshik.com/tests/208698-NAD_500mg_18EWQQVMK7IP'},
  WA10:{id:'WA10',slug:'bac-water',name:'BAC WATER',shortName:'BAC',description:'10ml bacteriostatic water support item for laboratory reconstitution workflows.',seoTitle:'Bacteriostatic Water 10ml UK | Laboratory Reconstitution | UKMAXX',seoDescription:'10ml bacteriostatic water from UKMAXX for laboratory reconstitution workflows. UK stocked support item with Royal Mail Tracked 24 dispatch.',purity:'UKMAXX Internal QC',batch:'WA10-2026-05-E',price:8.99,reviewCount:0,image:'./images/ukmaxx-bac-water.png',category:'support',featured:false,stock:'in_stock',stockCount:70,sortOrder:999,coa:{lab:'UKMAXX Internal QC',method:'Internal QC',status:'VERIFIED'},coaLabel:'UKMAXX Internal QC'},
  GHKCU:{id:'GHKCU',slug:'ghk-cu-50mg',name:'GHK-Cu 50MG',shortName:'GHK-Cu',description:'GHK-Cu 50mg lyophilised copper peptide, UK stocked with published Janoshik COA.',seoTitle:'GHK-Cu 50mg UK Research Peptide | COA Verified | UKMAXX',seoDescription:'GHK-Cu 50mg research peptide from UKMAXX. UK stocked, Janoshik HPLC COA verified, batch-traceable and dispatched with Royal Mail Tracked 24. Research use only.',purity:'99.799%',batch:'GHK-2026-05-A',price:29.99,reviewCount:0,image:'./images/ukmaxx-ghk-cu.png',category:'peptides',featured:false,stock:'in_stock',stockCount:19,sortOrder:30,coa:{lab:'Janoshik Analytical',method:'HPLC',status:'VERIFIED'},coaImage:'./images/ghkcu-coa-2026-07.png',coaSampleImage:'./images/ghkcu-coa-vial-2026-07.jpg',coaUrl:'https://verify.janoshik.com/tests/208700-GHKCu_50mg_ENTH4P5LPBYX'}
};
