-- Release verified RT20 stock and its full-price 3-pack bundle.
-- Janoshik report #225850, batch RT20-2026-08-A, 23.20mg Retatrutide, 99.607%, analysed 27 Aug 2026.
-- One RT20X3 order item consumes 3x RT20 and 1x WA10.
-- RT20 and RT20X3 remain MAXX10 eligible because neither is a launch-price SKU.

insert into public.products (
  sku, name, slug, description, price, stock_quantity, is_active, image_url
)
values
  (
    'RT20',
    'RETA 20MG',
    'retatrutide-20mg',
    'Retatrutide 20mg lyophilised research peptide from verified batch RT20-2026-08-A.',
    94.99,
    49,
    true,
  ...
  (
    'RT20X3',
    'RETA 20MG 3-PACK',
    'retatrutide-20mg-3-pack',
    'Three Retatrutide 20mg research vials from verified batch RT20-2026-08-A plus one BAC Water 10ml vial.',
    284.99,
    0,
    true,
...
insert into public.coa_batches (
  ...
  'Janoshik Analytical',
  'https://verify.janoshik.com/tests/225850-RT20_QX5EZXK4B9YV',
...
begin
  ...
  loop
    ...
    if v_sku in ('RT10X3', 'RT20X3', 'BC5X3', 'GHKCUX3', 'UKXRB1') then
...
grant select on public.products, public.coa_batches to anon, authenticated;
