-- Add the full-price GHK-Cu 3-pack bundle.
-- One GHKCUX3 order item consumes 3x GHKCU and 1x WA10.
...
values (
  ...
  'GHK-Cu 3-PACK',
  'ghk-cu-50mg-3-pack',
  'Three GHK-Cu 50mg copper peptide vials from batch GHK-2026-05-A plus one BAC Water 10ml vial.',
  89.99,
  0,
  true,
  './images/ukmaxx-ghkcu-bundle.png'
)
...
begin
  ...
  loop
    ...
    if v_sku in ('RT10X3', 'BC5X3', 'GHKCUX3') then
