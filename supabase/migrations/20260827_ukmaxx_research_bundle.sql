-- Add the UKMAXX flagship research bundle.
-- One UKXRB1 order item consumes 1x RT10, 1x BC5, 1x GHKCU and 1x WA10.
-- MAXX10 remains eligible; the discounted total is still above the free-shipping threshold.
...
values (
  'UKXRB1',
  'UKMAXX RESEARCH BUNDLE',
  'ukmaxx-research-bundle',
  'One RETA 10mg vial, one BPC-157 5mg vial, one GHK-Cu 50mg vial and one BAC Water 10ml vial, with three published independent COA records.',
  114.99,
  0,
  true,
  './images/ukmaxx-research-bundle.png'
)
...
begin
  ...
  loop
    ...
    if v_sku in ('RT10X3', 'BC5X3', 'GHKCUX3', 'UKXRB1') then
